        ...
        routes: [
          {
            path: '/defect/inv',
            name: 'inv',
            component: './Defect/Inv/List',
            authority: ['DefectInv_Read'],
          },
          {
            path: '/defect/repair',
            name: 'repair',
          ...
          },
          {
            path: '/defect/check',
            name: 'check',
            component: './Defect/Check/List',
            authority: ['DefectCheck_Read'],
            routes: [
              {
                path: '/defect/check/create',
                name: 'create',
                component: './Defect/Check/Create',
                authority: ['DefectCheck_Create'],
                hideInMenu: true,
              },
              {
                path: '/defect/check/update',
                name: 'update',
                component: './Defect/Check/Update',
                authority: ['DefectCheck_Update'],
                hideInMenu: true,
              },
              {
                path: '/defect/check/profile',
                name: 'profile',
