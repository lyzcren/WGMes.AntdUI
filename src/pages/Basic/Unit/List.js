...
@connect(({ unitManage, loading }) => ({
  unitManage,
  loading: loading.models.unitManage,
}))
@Form.create()
class TableList extends PureComponent {
  ...
  handleExport = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      exportExcel('/api/unit/export', pagination, fileName);
    });
  };
